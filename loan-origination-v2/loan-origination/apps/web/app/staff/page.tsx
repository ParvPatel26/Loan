  ...
  return (
    <main className="mx-auto min-h-screen max-w-2xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6 text-sm text-gray-500 shadow-sm">
        The review queue (applications escalated by the Decision Agent) is built in a
        later phase. You're logged in as bank staff — this is the landing point the
        login redirect sends you to.
      </div>
    </main>
  );
}
